...
public class ActionFactory {
    ...
    static{
        map(ADMIN_INSTRUCTORS_PAGE, AdminInstructorsPageAction.class);
        map(ADMIN_EDIT_INSTRUCTOR_PAGE, AdminEditInstructor.class);
        map(ADMIN_EDIT_INSTRUCTOR_PAGE_ACTION, AdminEditInstructorAction.class);
